...
def find_best_pairs_tab():
    ...
    with col1:
        base_ticker = st.text_input("Base Ticker for Pairs Analysis", value="SPY", key="base_ticker")
    ...
    if run_analysis and base_ticker:
        with st.spinner(f"🔍 Analyzing pairs for {base_ticker}..."):
            ...
            if results and results['pairs']:
                ...
                st.session_state['base_ticker'] = base_ticker
...
def detailed_analysis_tab():
    ...
    base_ticker = st.session_state['base_ticker']
